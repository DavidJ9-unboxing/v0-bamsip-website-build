 ...
 */
export const VENUE_LAUNCH_HERO = "https://www.bamsip.com/images/hero-night.png"
...
export const VENUE_LAUNCH_SUBJECT = "{{venueName}}: first round's on us?"

/** Default branded template content for the venue launch campaign. */
export function defaultVenueLaunchContent(_ctaUrl: string): VenueEmailContent {
  return {
    mode: "template",
